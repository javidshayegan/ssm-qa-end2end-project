@ORScheduler_ConformRevisedRequestApprove1
Feature: OR Scheduler, I want to approve request revision initiated by Office Scheduler_1
...
@Approve0
  ...
  Scenario: Request revision against procedure
    ...
    Then the request has Needs Revision alert
      | Time not available | Other | Request Revision Test |
    And Browser quits
  ...
  Scenario: Office Scheduler mark as resolved
    ...
    | Change procedure time | Mark As Resolved Test |
    And Browser quits
