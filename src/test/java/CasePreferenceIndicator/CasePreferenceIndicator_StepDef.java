...
public class CasePreferenceIndicator_StepDef {
	...
	@When("{string} clicks EDIT FILTERS")
	...
	public void the_right_pane_has_following_surgeons(io.cucumber.datatable.DataTable dataTable) {
		...
		actualSurgeons.add("Werther DMD, John R.");
	...
	public void clicks_checkbox_one_surgeon(String string, String surgeon) {
		...
		if (step.driver().findElement(By.xpath("//input[contains(@id,'checkbox_all')]")).isEnabled() ) {
			step.wait(500);
		}else {
			step.driver().findElement(By.xpath("//div[@data-field = 'checkbox_6125893c6d6886001042dcb8']")).click();
		}
