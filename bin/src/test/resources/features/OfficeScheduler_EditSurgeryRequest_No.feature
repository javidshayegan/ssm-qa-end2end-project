@OfficeScheduler_EditSurgeryRequest_No
Feature: As Office Scheduler, I want to edit surgery request initiated by OR Scheduler
  ...
  Scenario: going back to the homepage and verify the request
    ...
    Then "user" should be able to see the request just made
      ...
      | Brad, Pitts Test | Shoulder Arthroscopy | Ascension Saint Thomas Hospital Midtown BH CSC | Cordovez MD, Leah |
