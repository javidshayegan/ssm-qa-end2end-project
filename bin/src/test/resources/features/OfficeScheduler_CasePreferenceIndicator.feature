...
Feature: Office Scheduler Case Preference Indicator
  ...
  Scenario: validate EDIT VIEW page
		...
		Then "user" is taken to "https://casetracker-qa.app.cloud-02.pcf.ascension.org/accountSettings/myFilters"
		And The left pane has following forms 
			| Account Settings | Surgeons |
		And The right pane has following surgeons  
			| Werther DMD, John R. | Dovan MD, Thomas T. | Elrod MD, Burton F.| Glattes MD, Rudolph C. | Martin DO, Amanda D. | Moore MD, David R. | Willers MD, Jeffrey D. |
	...
	Scenario Outline: I want to set one surgeon
		Given "user" clicks EDIT FILTERS 
